...
<header>
    ...
    if (Yii::$app->user->isGuest) {
        ...
        $menuItems[] = ['label' => 'Informações', 'url' => ['/site/indexacesso']];
        ...
        if($funcao == 'instalador') {
            ...
            $menuItems[] = ['label' => 'Orçamentos', 'url' => ['/orcamento/index']];

        }
        $menuItems[] = ['label' => 'Produtos', 'url' => ['/produto/index']];
        $menuItems[] = ['label' => 'Questões', 'url' => ['/questao/index']];
        $menuItems[] = ['label' => 'Dados Pessoais', 'url' => ['/dadospessoais/dados']];
        $menuItems[] = '<li>'
